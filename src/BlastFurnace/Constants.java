...
public class Constants {
    ...
    public static int barDispenserFullID = 9095;
    public static int [] staminaPotions = {12631, 12629, 12627, 12625};
    ...
    public static Tile [] barDispenserTile = {new Tile(1940, 4962, 0)};
